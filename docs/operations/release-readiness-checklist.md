...
| Security headers | Ready | Staging and production security-header smoke workflows passed against their public HTTPS hostnames. Production verification against `https://time-archive.com` covered HSTS, frame policy, content type sniffing protection, conservative referrer policy, minimal CSP, browser permission restrictions, and public API proxy headers. Repeat after Web routing, Cloudflare, or header-policy changes. |
